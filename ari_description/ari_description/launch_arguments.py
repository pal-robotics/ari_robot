...
class AriArgs:
    ...
    camera_model_head: DLA = __arg_creator.get_argument('camera_model_head')
    camera_model_front: DLA = __arg_creator.get_argument('camera_model_front')
    camera_model_back: DLA = __arg_creator.get_argument('camera_model_back')
